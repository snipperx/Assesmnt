                ...
                <div class="card card-secondary">
                  <span class="card-body d-lg-flex align-items-center">
                    <p class="mb-lg-0">Get tons of UI components, Plugins, multiple layouts, 20+ sample pages, and more! </p>
                      <button type="button" class="btn btn-warning purchase-button btn-sm my-1 my-sm-0 ml-auto"
                              data-toggle="modal" data-target="#add-new-dependencies-modal">Warning</button>
